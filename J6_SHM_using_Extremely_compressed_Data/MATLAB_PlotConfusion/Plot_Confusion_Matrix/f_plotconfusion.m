function out1 = f_plotconfusion(varargin)
                ...
                for j=1:numColumns
                    for k=1:numColumns
                        ...
                        axisdata.number(j,k) = text(j,k,'', ...
                            ...
                            'FontWeight',topbold,...
                            'Color',topcolor,...
                            'FontSize',15); % 3class-->15;% 4class-->15; 8class-->8
                        axisdata.percent(j,k) = text(j,k,'', ...
                            'HorizontalAlignment','center',...
                            'VerticalAlignment','top',...
                            'FontWeight',bottombold,...
                            'Color',bottomcolor,...
                            'FontSize',10);  % 3class-->10;% 4class-->10; 8class-->10
                    end
                end
                plot([0 0]+numColumns-0.5,[mn mx],'LineWidth',3,'Color',[0 0 0]+0.0);
                plot([mn mx],[0 0]+numColumns-0.5,'LineWidth',3,'Color',[0 0 0]+0.0);
                xlabel('True Class',titleStyle{:});
                ylabel('Predicted Class',titleStyle{:});
